...
var JS_TEMPLATE_PATH = path.join(__dirname, '/../tpl/config.tpl.js');
...
var JavaScriptFormatter = function () {
  ...
  this.writeConfigFile = function (configPath, answers) {
    fs.writeFileSync(configPath, this.generateConfigFile(answers));
  };
};

exports.createForPath = function () {
